...
describe('<TableConnected />', () => {
    ...
    describe('after render', () => {
        ...
        it('should call the manual thunk if it is passed as own props on onModifyData', () => {
            ...
            expect(_.rest(manualSpy.mock.calls[manualSpy.mock.calls.length - 1].args)).toEqual([
                shouldResetPage,
                tableComposite1,
                tableComposite2,
            ]);
        ...
        it('should call the default data modifier thunk if manual is not in ownProps on onModifyData', () => {
            ...
            const tableConnected = wrapper.find(Table);
            const defaultTableStateModifierThunkSpy = jest.spyOn(
                TableDataModifier,
            ...
            expect(_.rest(defaultTableStateModifierThunkSpy.mock.calls[defaultTableStateModifierThunkSpy.mock.calls.length - 1].args)).toEqual([
                shouldResetPage,
                tableComposite1,
            ]);
        });
